function clicked(zodiacSign) {
  document.querySelector(".popup-card-elements-container").style.display =
    "none";
...
function getHoroscope(zodiacSign) {
  ...
  fetch(URL, {
    ...
    .then((json) => {
      document.getElementById("user-popup-card-daily-reading-text").innerHTML =
        json.description;
      ...
      document.getElementById("user-lucky-number").innerHTML =
        json.lucky_number;
    ...
    .catch((error) => {
      ...
      document.getElementById("user-lucky-number").innerHTML =
        dummyData.lucky_number;
      document.getElementById("user-lucky-time").innerHTML =
        dummyData.lucky_time;
      document.querySelector(".loader-container").style.display = "none";
      document.querySelector(".popup-card-elements-container").style.display =
        "flex";
    });
